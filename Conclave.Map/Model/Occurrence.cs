...
namespace Conclave.Map.Model {
	public sealed class Occurrence : IData, IEquatable<Occurrence> {
		...
		public string StringData {
			get {
				if (this.HasEncodedData && _stringData == null) {
					_stringData = Occurrence.StringEncoding.GetString(this.EncodedData);
				}
		...
		public Occurrence(Occurrence occurrence) : this(occurrence.Parent, occurrence.Scope, occurrence.Role, occurrence.Behaviour, occurrence.Reference, occurrence.EncodedData) { }
		...
		public Occurrence(string parent, string scope, string role, string behaviour, string reference, string data): this(parent, scope, role, behaviour, reference) {
			_encodedData = Occurrence.StringEncoding.GetBytes(data);
		}
		...
		public class Builder {
			...
			public string StringData {
				get {
					if (this.EncodedData != null) {
						return Occurrence.StringEncoding.GetString(this.EncodedData);
					} else {
						return String.Empty;
					}
				}
				set {
					...
					this.EncodedData = Occurrence.StringEncoding.GetBytes(value);
				}
			}
			...
			public Builder FromOccurrence(Occurrence occurrence) {
				...
				this.EncodedData = occurrence.EncodedData;
				return this;
			}

			public Occurrence ToOccurrence() {
				return new Occurrence(this.Parent, this.Scope, this.Role, this.Behaviour, this.Reference, this.EncodedData);
			}
		}
