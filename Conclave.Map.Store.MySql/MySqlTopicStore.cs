...
namespace Conclave.Map.Store {
	...
	/// <summary>
	/// An implementation of <see cref="ITopicStore"/>
	/// for MySql.
	/// </summary>
	/// <remarks>
	/// This is implemented as a <see cref="SqlStore"/>, and internally
	/// uses the extensions provided by <see cref="DataReaderEx"/>.
	/// </remarks>
	public class MySqlTopicStore : SqlTopicStore {

		public MySqlTopicStore(string connStr)
		...
		/// </summary>
		/// <remarks>
		/// This is useful for updating the labels of pointing assocs.
		/// </remarks>
		/// <param name="id"/><param name="assocType">The type of assocs to consider.</param><param name="assocRole">The role of assocs to consider.</param><param name="metaScope">The scope of metadata to consider.</param><param name="metaName">The name of metadata to consider.</param><param name="metaValue">The value to set for the metadata.</param>
		public override void UpdateMetadataForPointingAssociations(string id, string assocType, string assocRole, string metaScope,
